 ...
 *
 * @usage wbads.init( '/4321/acme/widgets', { debug_enabled: true }, { collapse_empty_divs: true, global_targeting: { category: "kids" } });
 *          ...discovery method...
...
var wbads = (function($, googletag, window, document, undefined) {
    ...
    /*
     * sets up the config object. (to be called explicitly from the page ie wbads.init('/4321/acme/widgets') )
     ...
     *
     */
    function init(ad_unit_path, options, dfp_options) {
        var initArgs = {ad_unit_path: ad_unit_path, options: options, dfp_options: dfp_options};
        trigger("filter.init.args", initArgs);

        ad_unit_path = initArgs.ad_unit_path;
